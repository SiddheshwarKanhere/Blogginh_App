...
import com.CodeWithDurgeh.Blog.services.FileService;
import com.CodeWithDurgeh.Blog.services.PostService;
...
public class PostController {
	...
	public ResponseEntity<PostResponse> getAllPost(
			...
			@RequestParam(value = "sortDir", defaultValue = AppConstants.SORT_DIY, required = false) String sortDir) {
	...
	public ApiResponce deletePost(@PathVariable Integer postId) {
		...
		return new ApiResponce("Post is successfuly deleted !!", true);
