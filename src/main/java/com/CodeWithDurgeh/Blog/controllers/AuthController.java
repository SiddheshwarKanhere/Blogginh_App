...
import com.CodeWithDurgeh.Blog.exceptions.ApiException;
import com.CodeWithDurgeh.Blog.paylodes.JwtAuthRequest;
import com.CodeWithDurgeh.Blog.paylodes.JwtAuthResponse;
import com.CodeWithDurgeh.Blog.paylodes.UserDto;
import com.CodeWithDurgeh.Blog.security.JwtTokenHelper;
...
public class AuthController {
	...
	public ResponseEntity<UserDto> registerTheNewUser(@RequestBody UserDto userDto){
		...
		UserDto registerdUser = this.userServices.registerNewUser(userDto);
